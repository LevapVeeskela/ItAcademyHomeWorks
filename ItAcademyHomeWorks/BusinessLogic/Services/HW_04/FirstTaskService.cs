...
namespace BusinessLogic.Services.HW_04
{
    public class FirstTaskService
    {
        public void ShowEnglishAlphabet()
        {
            var firstLetter = 'a';
            var endLetter = 'z';
            Console.WriteLine($"Первый пример, {HomeWorkFour.TextEnglishAlphabetUnicodeInfo}");
        ...
        public void ShowEnglishAlphabetFromUnicodeTableDecNumber()
        {
            var firstLetter = 97;
            var endLetter = 122;
            Console.WriteLine($"Второй пример, {HomeWorkFour.TextEnglishAlphabetUnicodeInfo}");
        ...
        public void ShowEnglishAlphabetUnicodeTableEscapeSequence()
        {
            var firstLetter = '\u0061';
            var endLetter = '\u007A';
            Console.WriteLine($"Третий пример,{HomeWorkFour.TextEnglishAlphabetUnicodeInfo}");
            for (var letterNumberUnicodeTable = firstLetter; letterNumberUnicodeTable <= endLetter; letterNumberUnicodeTable++)
            {
        ...
        public void ShowEnglishAlphabetUnicodeTableLinq()
        {
            ...
            Console.WriteLine($"Четвертый пример с использованием LINQ, {HomeWorkFour.TextEnglishAlphabetUnicodeInfo}");
